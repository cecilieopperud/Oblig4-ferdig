...
public class Legesystem{
        ...
        if(input == 0) {
          ...
          if(input == 5){
            ...
            if(svar.contains("lege")){
              System.out.println("Skriv inn navn paa lege: ");
              String legensNavn = les.nextLine().toLowerCase();
              Lege nyLege = new Lege(legensNavn);
              legeListe.leggTil(nyLege);
            }
            else if(svar.contains("spesialist")){
              System.out.println("Skriv inn navn paa spesialist: ");
              String spesialistensNavn = les.nextLine().toLowerCase();
  ...
  private void pasienterGyldig(){
    int teller = 0;
    System.out.println("Oversikt over narkotiske legemidler pr Pasient: \n");
    for (int i = 0; i< pasientListe.stoerrelse(); i ++){
